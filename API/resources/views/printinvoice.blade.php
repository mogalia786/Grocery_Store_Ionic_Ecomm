                                                                            ...
                                                                            <p
                                                                                ...
                                                                                @if($order->variations && !empty($order->variations))
                                                                                    @if($order->variations[0]->items[$order->variant]->discount > 0)
                                                                                        {{$currencySymbol}} {{$order->variations[0]->items[$order->variant]->discount}}
                                                                                    @endif

                                                                                    @if($order->variations[0]->items[$order->variant]->discount <= 0)
                                                                                        {{$currencySymbol}} {{$order->variations[0]->items[$order->variant]->price}}
                                                                                    @endif
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div
                                                                            ...
                                                                            <p
                                                                                style="margin: 0; font-size: 14px; text-align: right;">
                                                                                @if($order->discount > 0)
                                                                                   {{$currencySymbol}} {{$order->sell_price}}
                                                                                @endif
                                                                                @if($order->discount <= 0)
                                                                                   {{$currencySymbol}} {{$order->original_price}}
                                                                                @endif
                                                                            </p>
                                                                        </div>
                                                                    </div>
